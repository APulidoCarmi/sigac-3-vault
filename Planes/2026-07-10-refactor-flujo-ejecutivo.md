...
### Fase 5 — Ajustes post-cierre (agregados 2026-07-12)
- [[2026-07-10-refactor-flujo-ejecutivo-sp19-configuracion-pedimento-en-dgo]] — Configuración de datos de pedimento a nivel DGO (aduana/clave/patente/régimen editables en el DGO, arreglo de grupos congelados en el wizard de Operación con 2+ DGOs, backend resolviendo datos de pedimento desde el DGO en vez de confiar en el payload del cliente). Originado por revisión dirigida contra [[2026-07-07 - Revision de pantallas flujo operación]]. ✍️ Redactado — listo para `/implementa`.
