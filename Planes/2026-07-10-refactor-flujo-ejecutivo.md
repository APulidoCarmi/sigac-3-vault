...
- [[2026-07-10-refactor-flujo-ejecutivo-sp02-wizard-crear-referencia]] — Wizard 3 pasos (#3). 🟡 Parcialmente implementado (2026-07-11): gate estático verde en ambos repos; el bloqueo de migración Prisma que tenía documentado se resolvió (`pnpm db:setup`, ver nota de Fase 1 más abajo), pero quedan dos decisiones de producto sin validar con negocio (distinción cliente/ejecutivo inferida vía `IsInternalUser`; destino de `stepChecklistGlosa`/`stepInvoicesReference` sin resolver) — ver manifiesto.
